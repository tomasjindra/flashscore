...
## Input parameters
- **inputURL** - The list of input URLs to be used. It can be URL for a specific team, player or league (e.g.https://www.livesport.com/en/soccer/england/premier-league/#/nunhS7Vn/table/overall 
